...
from robot_sim.robots_envs import turtlebot_env
...
register(
        id='Turtlebot_Task',
        entry_point='robot_sim.task_envs.Task.taskenv:TurtlebotTaskEnv',
        max_episode_steps=1000,
    )

class TurtlebotTaskEnv(turtlebot_env.TurtlebotEnv):
    def __init__(self):
        ...
        turtlebot_env.TurtlebotEnv.__init__(
