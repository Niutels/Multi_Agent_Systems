...
if("TRUE" STREQUAL "TRUE")
  set(robot_sim_SOURCE_PREFIX /home/hcappel1/Multi_Agent_Systems/src/robot_sim)
  set(robot_sim_DEVEL_PREFIX /home/hcappel1/Multi_Agent_Systems/devel/.private/robot_sim)
  ...
  set(robot_sim_INSTALL_PREFIX /home/hcappel1/Multi_Agent_Systems/install)
...
if(NOT "/home/hcappel1/Multi_Agent_Systems/devel/.private/robot_sim/include " STREQUAL " ")
  set(robot_sim_INCLUDE_DIRS "")
  set(_include_dirs "/home/hcappel1/Multi_Agent_Systems/devel/.private/robot_sim/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'nicolas_b <nicolas_b@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hcappel1/Multi_Agent_Systems/src/robot_sim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hcappel1/Multi_Agent_Systems/devel/.private/robot_sim/lib;/home/hcappel1/Multi_Agent_Systems/devel/lib;/opt/ros/kinetic/lib)
